...
?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Read sent mail</li>
      </ol>
    </section>
          ...
          <div class="box box-solid box-default">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                <h3><?=$app->getTable('Messagessent')->findattr('mail', $id)->mail?></h3>
                <h5>Subject: <?=$app->getTable('Messagessent')->findattr('sujet', $id)->sujet?>
                  <span class="mailbox-read-time pull-right">
                    <?=$app->getTable('Messagessent')->findattr('datepub', $id)->datepub?>
                  </span>
                </h5>
              </div>
              <!-- /.mailbox-read-info -->
              ...
              <div class="mailbox-read-message">
                <p style="text-align:justify"><?=$app->getTable('Messagessent')->findattr('contenu', $id)->contenu?></p>
              </div>
